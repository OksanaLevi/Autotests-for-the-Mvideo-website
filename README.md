...
<ol>
  ...
  <li>
        <b>Requests</b> - классы для описания параметров запуска разных категорий тестов с ссылкой на подходущую Спецификацию.
    </li>
    <li>
        <b>Methods</b> - методы, описывающие взаимодействия с запросами и их обработкой(получения токена аутентификации, создание записи бронирования)
    </li>
    <li>
